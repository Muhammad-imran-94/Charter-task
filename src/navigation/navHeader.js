          ...
          <div>
            <ul className="mid-nav flex-row">
             ...
             <div className="pop-items">
              ...
              <div className="nav-pop2">
              <div className="pop-items2">
              <li>
              ...
              <div className="nav-pop3">
              <div className="pop-items3">
              <li>
                <a href="Export/Share">Export / Share</a>
              </li>
              </div>
              </div>
              <div className="nav-pop4">
              <div className="pop-items4">
              <li>
                <a href="FAQS">Support / FAQs</a>
              </li>
              </div>
              </div>
              <div className="nav-pop5">
              <div className="pop-items5">
              <li>
